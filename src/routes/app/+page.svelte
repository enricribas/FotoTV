...
<svelte:head>
	<title>FotoTV - Photo Slideshow App</title>
	<meta name="description" content="Transform your TV into a beautiful photo slideshow display" />
</svelte:head>
		...
		>
			...
			<div class="text-sm text-gray-800">
				...
				<div class="text-xs text-gray-500">
					...
					v{typeof __APP_VERSION__ !== 'undefined' ? __APP_VERSION__ : '4.22.1'} | {userCollections.length}
					collections
				</div>
			</div>
		</button>
