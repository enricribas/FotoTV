import{q as el,aH as Tf,aI as If,aJ as wf,aK as Af,aL as Rf,aM as Sf}from"./xY4BzElm.js";const bf=Symbol("is custom element"),Pf=Symbol("is html");function pI(n){if(el){var e=!1,t=()=>{if(!e){if(e=!0,n.hasAttribute("value")){var r=n.value;gc(n,"value",null),n.value=r}if(n.hasAttribute("checked")){var s=n.checked;gc(n,"checked",null),n.checked=s}}};n.__on_r=t,Tf(t),If()}}function gc(n,e,t,r){var s=Cf(n);el&&(s[e]=n.getAttribute(e),e==="src"||e==="srcset"||e==="href"&&n.nodeName==="LINK")||s[e]!==(s[e]=t)&&(e==="loading"&&(n[wf]=t),t==null?n.removeAttribute(e):typeof t!="string"&&kf(n).includes(e)?n[e]=t:n.setAttribute(e,t))}function Cf(n){return n.__attributes??={[bf]:n.nodeName.includes("-"),[Pf]:n.namespaceURI===Af}}var _c=new Map;function kf(n){var e=_c.get(n.nodeName);if(e)return e;_c.set(n.nodeName,e=[]);for(var t,r=n,s=Element.prototype;s!==r;){t=Sf(r);for(var i in t)t[i].set&&e.push(i);r=Rf(r)}return e}const Df=()=>{};var yc={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mI(n,e){if(De(n.app))return Promise.reject(He(n));const t=lt(n),r=await pg(t,{token:e,returnSecureToken:!0}),s=await Pt._fromIdTokenResponse(t,"signIn",r);return await t._updateCurrentUser(s.user),s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xl(n){const e=lt(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function gI(n,e,t){const r=lt(n);await ys(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",sg)}async function _I(n,e,t){if(De(n.app))return Promise.reject(He(n));const r=lt(n),a=await ys(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",lg).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&xl(n),l}),u=await Pt._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(u.user),u}function yI(n,e,t){return De(n.app)?Promise.reject(He(n)):fg(Y(n),Rn.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&xl(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function EI(n,{displayName:e,photoURL:t}){if(e===void 0&&t===void 0)return;const r=Y(n),i={idToken:await r.getIdToken(),displayName:e,photoUrl:t,returnSecureToken:!0},a=await _n(r,mg(r.auth,i));r.displayName=a.displayName||null,r.photoURL=a.photoUrl||null;const u=r.providerData.find(({providerId:l})=>l==="password");u&&(u.displayName=r.displayName,u.photoURL=r.photoURL),await r._updateTokensIfNecessary(a)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gg(n,e){return Y(n).setPersistence(e)}function _g(n,e,t,r){return Y(n).onIdTokenChanged(e,t,r)}function yg(n,e,t){return Y(n).beforeAuthStateChanged(e,t)}function vI(n,e,t,r){return Y(n).onAuthStateChanged(e,t,r)}function TI(n){return Y(n).signOut()}const vs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ud="storage";function kI(n,e,t){return n=Y(n),JT(n,e,t)}function DI(n){return n=Y(n),YT(n)}function NI(n){return n=Y(n),eI(n)}function VI(n){return n=Y(n),tI(n)}function OI(n,e){return n=Y(n),iI(n,e)}function aI(n=Ls(),e){n=Y(n);const r=Os(n,Ud).getImmediate({identifier:e}),s=il("storage");return s&&cI(r,...s),r}function cI(n,e,t,r={}){oI(n,e,t,r)}function uI(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new pa(t,r,s,e,Yt)}function lI(){Gt(new bt(Ud,uI,"PUBLIC").setMultipleInstances(!0)),qe(Yu,Zu,""),qe(Yu,Zu,"esm2017")}lI();const hI={apiKey:"AIzaSyDXlu3twONtxnlsSYAjJcLng0UsNEgKkkg",authDomain:"fototv-90cf0.firebaseapp.com",projectId:"fototv-90cf0",storageBucket:"fototv-90cf0.firebasestorage.app",messagingSenderId:"341116492373",appId:"1:341116492373:web:74768f1c508198574d12dc",measurementId:"G-K7K2NXMWW3"},ma=nm().length?Ls():hl(hI),dI=P_(ma);gg(dI,Bl).catch(n=>console.error("Error setting auth persistence:",n));const LI=kv(ma),MI=aI(ma);console.log("Firebase initialized with email/password authentication");export{mI as A,pI as B,bt as C,kI as D,_I as E,Ye as F,EI as G,yI as H,gI as I,TI as J,te as T,Gt as _,dI as a,gc as b,qe as c,VI as d,De as e,Ls as f,NI as g,Os as h,Y as i,il as j,Mt as k,DI as l,PI as m,wI as n,vI as o,_o as p,LI as q,OI as r,MI as s,CI as t,yo as u,AI as v,RI as w,SI as x,bI as y,Cv as z};
