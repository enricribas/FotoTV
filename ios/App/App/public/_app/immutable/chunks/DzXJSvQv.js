import{k as vo,aJ as vc,aK as wc,aL as Ic,aM as Ec,aN as Tc}from"./BEP-pFgy.js";import{c as Ac}from"./BO6TyhyF.js";const Sc=Symbol("is custom element"),bc=Symbol("is html");function bp(t){if(vo){var e=!1,n=()=>{if(!e){if(e=!0,t.hasAttribute("value")){var r=t.value;ms(t,"value",null),t.value=r}if(t.hasAttribute("checked")){var s=t.checked;ms(t,"checked",null),t.checked=s}}};t.__on_r=n,vc(n),Ac()}}function ms(t,e,n,r){var s=Rc(t);vo&&(s[e]=t.getAttribute(e),e==="src"||e==="srcset"||e==="href"&&t.nodeName==="LINK")||s[e]!==(s[e]=n)&&(e==="loading"&&(t[wc]=n),n==null?t.removeAttribute(e):typeof n!="string"&&kc(t).includes(e)?t[e]=n:t.setAttribute(e,n))}function Rc(t){return t.__attributes??={[Sc]:t.nodeName.includes("-"),[bc]:t.namespaceURI===Ic}}var _s=new Map;function kc(t){var e=_s.get(t.nodeName);if(e)return e;_s.set(t.nodeName,e=[]);for(var n,r=t,s=Element.prototype;s!==r;){n=Tc(r);for(var a in n)n[a].set&&e.push(a);r=Ec(r)}return e}const Pc=()=>{};var ys={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oe=new Ki("@firebase/app"),Il="@firebase/app-compat",El="@firebase/analytics-compat",Tl="@firebase/analytics",Al="@firebase/app-check-compat",Sl="@firebase/app-check",bl="@firebase/auth",Rl="@firebase/auth-compat",kl="@firebase/database",Pl="@firebase/data-connect",Cl="@firebase/database-compat",Ol="@firebase/functions",Nl="@firebase/functions-compat",Dl="@firebase/installations",Ll="@firebase/installations-compat",Ul="@firebase/messaging",Ml="@firebase/messaging-compat",xl="@firebase/performance",Fl="@firebase/performance-compat",jl="@firebase/remote-config",Vl="@firebase/remote-config-compat",Bl="@firebase/storage",Hl="@firebase/storage-compat",$l="@firebase/firestore",Wl="@firebase/ai",zl="@firebase/firestore-compat",ql="firebase",Gl="11.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xi="[DEFAULT]",Kl={[Mi]:"fire-core",[Il]:"fire-core-compat",[Tl]:"fire-analytics",[El]:"fire-analytics-compat",[Sl]:"fire-app-check",[Al]:"fire-app-check-compat",[bl]:"fire-auth",[Rl]:"fire-auth-compat",[kl]:"fire-rtdb",[Pl]:"fire-data-connect",[Cl]:"fire-rtdb-compat",[Ol]:"fire-fn",[Nl]:"fire-fn-compat",[Dl]:"fire-iid",[Ll]:"fire-iid-compat",[Ul]:"fire-fcm",[Ml]:"fire-fcm-compat",[xl]:"fire-perf",[Fl]:"fire-perf-compat",[jl]:"fire-rc",[Vl]:"fire-rc-compat",[Bl]:"fire-gcs",[Hl]:"fire-gcs-compat",[$l]:"fire-fst",[zl]:"fire-fst-compat",[Wl]:"fire-vertex","fire-js":"fire-js",[ql]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ht=Gl;function Co(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:xi,automaticDataCollectionEnabled:!0},e),s=r.name;if(typeof s!="string"||!s)throw ze.create("bad-app-name",{appName:String(s)});if(n||(n=So()),!n)throw ze.create("no-options");const a=Xt.get(s);if(a){if(it(n,a.options)&&it(r,a.config))return a;throw ze.create("duplicate-app",{appName:s})}const l=new il(s);for(const f of Fi.values())l.addComponent(f);const u=new Yl(n,r,l);return Xt.set(s,u),u}function qn(t=xi){const e=Xt.get(t);if(!e&&t===xi&&So())return Co();if(!e)throw ze.create("no-app",{appName:t});return e}function Zl(){return Array.from(Xt.values())}function ve(t,e,n){var r;let s=(r=Kl[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const a=s.match(/\s|\//),l=e.match(/\s|\//);if(a||l){const u=[`Unable to register library "${s}" with version "${e}":`];a&&u.push(`library name "${s}" contains illegal characters (whitespace or "/")`),a&&l&&u.push("and"),l&&u.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Oe.warn(u.join(" "));return}rt(new qe(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ji(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function fh(){return Ps()==="http:"||Ps()==="https:"}function Ps(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ph(t,e){const n=await xo(t,{},async()=>{const r=tn({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:a}=t.config,l=await Fo(t,s,"/v1/token",`key=${a}`),u=await t._getAdditionalHeaders();u["Content-Type"]="application/x-www-form-urlencoded";const f={method:"POST",headers:u,body:r};return t.emulatorConfig&&lt(t.emulatorConfig.host)&&(f.credentials="include"),Mo.fetch()(l,f)});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function Ch(t,e){return Te(t,"POST","/v2/accounts:revokeToken",De(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ns=new Map;function Pe(t){Ne(t instanceof Function,"Expected a class definition");let e=Ns.get(t);return e?(Ne(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,Ns.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qh(t,e){const n=zn(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),a=n.getOptions();if(it(a,e??{}))return s;pe(s,"already-initialized")}return n.initialize({options:e})}function Gh(t,e){const n=e?.persistence||[],r=(Array.isArray(n)?n:[n]).map(Pe);e?.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e?.popupRedirectResolver)}function Kh(t,e,n){const r=Ge(t);k(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,a=Zo(e),{host:l,port:u}=Jh(e),f=u===null?"":`:${u}`,E={url:`${a}//${l}${f}/`},S=Object.freeze({host:l,port:u,protocol:a.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){k(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),k(it(E,r.config.emulator)&&it(S,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=E,r.emulatorConfig=S,r.settings.appVerificationDisabledForTesting=!0,lt(l)?(qi(`${a}//${l}${f}`),Gi("Auth",!0)):Xh()}function Zo(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function Jh(t){const e=Zo(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const a=s[1];return{host:a,port:xs(r.substr(a.length+1))}}else{const[a,l]=r.split(":");return{host:a,port:xs(l)}}}function xs(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function Xh(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cu(t,e,n=!1){const{auth:r}=t;if(oe(r.app))return Promise.reject(Ce(r));const s="reauthenticate";try{const a=await It(t,ea(r,s,e,t),n);k(a.idToken,r,"internal-error");const l=Qi(a.idToken);k(l,r,"internal-error");const{sub:u}=l;return k(t.uid===u,r,"user-mismatch"),ot._forOperation(t,s,a)}catch(a){throw a?.code==="auth/user-not-found"&&pe(r,"user-mismatch"),a}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ta(t,e,n=!1){if(oe(t.app))return Promise.reject(Ce(t));const r="signIn",s=await ea(t,r,e),a=await ot._fromIdTokenResponse(t,r,s);return n||await t._updateCurrentUser(a.user),a}async function lu(t,e){return ta(Ge(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function na(t){const e=Ge(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Rp(t,e,n){const r=Ge(t);await Vn(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",eu)}async function kp(t,e,n){if(oe(t.app))return Promise.reject(Ce(t));const r=Ge(t),l=await Vn(r,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",ou).catch(f=>{throw f.code==="auth/password-does-not-meet-requirements"&&na(t),f}),u=await ot._fromIdTokenResponse(r,"signIn",l);return await r._updateCurrentUser(u.user),u}function Pp(t,e,n){return oe(t.app)?Promise.reject(Ce(t)):lu(J(t),Tt.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&na(t),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uu(t,e){return J(t).setPersistence(e)}function du(t,e,n,r){return J(t).onIdTokenChanged(e,n,r)}function fu(t,e,n){return J(t).beforeAuthStateChanged(e,n)}function Op(t,e,n,r){return J(t).onAuthStateChanged(e,n,r)}function Np(t){return J(t).signOut()}const Hn="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ku(t,e){return e?Pe(e):(k(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ci="webStorageSupport";class gd{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=aa,this._completeRedirectFn=ju,this._overrideRedirectResult=Mu}async _openPopup(e,n,r,s){var a;Ne((a=this.eventManagers[e._key()])===null||a===void 0?void 0:a.manager,"_initialize() not called before _openPopup()");const l=await Ws(e,n,r,ji(),s);return ld(e,l,ir())}async _openRedirect(e,n,r,s){await this._originValidation(e);const a=await Ws(e,n,r,ji(),s);return yu(a),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:s,promise:a}=this.eventManagers[n];return s?Promise.resolve(s):(Ne(a,"If manager is not set, promise should be"),a)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await id(e),r=new Bu(e);return n.register("authEvent",s=>(k(s?.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(Ci,{type:Ci},s=>{var a;const l=(a=s?.[0])===null||a===void 0?void 0:a[Ci];l!==void 0&&n(!!l),pe(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=qu(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return Ko()||Ho()||er()}}const md=gd;var zs="@firebase/auth",qs="1.10.8";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function If(t,e,n){let r=1,s=null,a=null,l=!1,u=0;function f(){return u===2}let E=!1;function S(...P){E||(E=!0,e.apply(null,P))}function b(P){s=setTimeout(()=>{s=null,t(C,f())},P)}function T(){a&&clearTimeout(a)}function C(P,...q){if(E){T();return}if(P){T(),S.call(null,P,...q);return}if(f()||l){T(),S.call(null,P,...q);return}r<64&&(r*=2);let M;u===1?(u=2,M=0):M=(r+Math.random())*1e3,b(M)}let R=!1;function U(P){R||(R=!0,T(),!E&&(s!==null?(P||(u=2),clearTimeout(s),b(0)):P||(u=1)))}return b(0),a=setTimeout(()=>{l=!0,U(!0)},n),U}function Ef(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bf{constructor(e,n,r,s,a,l,u,f,E,S,b,T=!0,C=!1){this.url_=e,this.method_=n,this.headers_=r,this.body_=s,this.successCodes_=a,this.additionalRetryCodes_=l,this.callback_=u,this.errorCallback_=f,this.timeout_=E,this.progressCallback_=S,this.connectionFactory_=b,this.retry=T,this.isUsingEmulator=C,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((R,U)=>{this.resolve_=R,this.reject_=U,this.start_()})}start_(){const e=(r,s)=>{if(s){r(!1,new Pn(!1,null,!0));return}const a=this.connectionFactory_();this.pendingConnection_=a;const l=u=>{const f=u.loaded,E=u.lengthComputable?u.total:-1;this.progressCallback_!==null&&this.progressCallback_(f,E)};this.progressCallback_!==null&&a.addUploadProgressListener(l),a.send(this.url_,this.method_,this.isUsingEmulator,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&a.removeUploadProgressListener(l),this.pendingConnection_=null;const u=a.getErrorCode()===nt.NO_ERROR,f=a.getStatus();if(!u||Sf(f,this.additionalRetryCodes_)&&this.retry){const S=a.getErrorCode()===nt.ABORT;r(!1,new Pn(!1,null,S));return}const E=this.successCodes_.indexOf(f)!==-1;r(!0,new Pn(E,a))})},n=(r,s)=>{const a=this.resolve_,l=this.reject_,u=s.connection;if(s.wasSuccessCode)try{const f=this.callback_(u,u.getResponse());Tf(f)?a(f):a()}catch(f){l(f)}else if(u!==null){const f=hr();f.serverResponse=u.getErrorText(),this.errorCallback_?l(this.errorCallback_(u,f)):l(f)}else if(s.canceled){const f=this.appDelete_?Aa():df();l(f)}else{const f=uf();l(f)}};this.canceled_?n(!1,new Pn(!1,null,!0)):this.backoffId_=If(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&Ef(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class Pn{constructor(e,n,r){this.wasSuccessCode=e,this.connection=n,this.canceled=!!r}}function Rf(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function kf(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function Pf(t,e){e&&(t["X-Firebase-GMPID"]=e)}function Cf(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function Of(t,e,n,r,s,a,l=!0,u=!1){const f=Sa(t.urlParams),E=t.url+f,S=Object.assign({},t.headers);return Pf(S,e),Rf(S,n),kf(S,a),Cf(S,r),new bf(E,t.method,S,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,s,l,u)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bf(t){if(t.length===0)return null;const e=t.lastIndexOf("/");return e===-1?"":t.slice(0,e)}function Hf(t,e){const n=e.split("/").filter(r=>r.length>0).join("/");return t.length===0?n:t+"/"+n}function Pa(t){const e=t.lastIndexOf("/",t.length-2);return e===-1?t:t.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $f(t,e){return e}class ne{constructor(e,n,r,s){this.server=e,this.local=n||e,this.writable=!!r,this.xform=s||$f}}let Cn=null;function Wf(t){return!ur(t)||t.length<2?t:Pa(t)}function Ca(){if(Cn)return Cn;const t=[];t.push(new ne("bucket")),t.push(new ne("generation")),t.push(new ne("metageneration")),t.push(new ne("name","fullPath",!0));function e(a,l){return Wf(l)}const n=new ne("name");n.xform=e,t.push(n);function r(a,l){return l!==void 0?Number(l):l}const s=new ne("size");return s.xform=r,t.push(s),t.push(new ne("timeCreated")),t.push(new ne("updated")),t.push(new ne("md5Hash",null,!0)),t.push(new ne("cacheControl",null,!0)),t.push(new ne("contentDisposition",null,!0)),t.push(new ne("contentEncoding",null,!0)),t.push(new ne("contentLanguage",null,!0)),t.push(new ne("contentType",null,!0)),t.push(new ne("metadata","customMetadata",!0)),Cn=t,Cn}function zf(t,e){function n(){const r=t.bucket,s=t.fullPath,a=new re(r,s);return e._makeStorageReference(a)}Object.defineProperty(t,"ref",{get:n})}function qf(t,e,n){const r={};r.type="file";const s=n.length;for(let a=0;a<s;a++){const l=n[a];r[l.local]=l.xform(r,e[l.server])}return zf(r,t),r}function Oa(t,e,n){const r=fr(e);return r===null?null:qf(t,r,n)}function Gf(t,e,n,r){const s=fr(e);if(s===null||!ur(s.downloadTokens))return null;const a=s.downloadTokens;if(a.length===0)return null;const l=encodeURIComponent;return a.split(",").map(E=>{const S=t.bucket,b=t.fullPath,T="/b/"+l(S)+"/o/"+l(b),C=ln(T,n,r),R=Sa({alt:"media",token:E});return C+R})[0]}function Kf(t,e){const n={},r=e.length;for(let s=0;s<r;s++){const a=e[s];a.writable&&(n[a.server]=t[a.local])}return JSON.stringify(n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ct{constructor(e,n){this._service=e,n instanceof re?this._location=n:this._location=re.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new ct(e,n)}get root(){const e=new re(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Pa(this._location.path)}get storage(){return this._service}get parent(){const e=Bf(this._location.path);if(e===null)return null;const n=new re(this._location.bucket,e);return new ct(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw vf(e)}}function cp(t,e,n){t._throwIfRoot("uploadBytes");const r=sp(t.storage,t._location,Ca(),new $e(e,!0),n);return t.storage.makeRequestWithTokens(r,Yn).then(s=>({metadata:s,ref:t}))}function lp(t){const e={prefixes:[],items:[]};return Da(t,e).then(()=>e)}async function Da(t,e,n){const s=await hp(t,{pageToken:n});e.prefixes.push(...s.prefixes),e.items.push(...s.items),s.nextPageToken!=null&&await Da(t,e,s.nextPageToken)}function hp(t,e){e!=null&&typeof e.maxResults=="number"&&Wi("options.maxResults",1,1e3,e.maxResults);const n=e||{},r=ep(t.storage,t._location,"/",n.pageToken,n.maxResults);return t.storage.makeRequestWithTokens(r,Yn)}function up(t){t._throwIfRoot("getDownloadURL");const e=tp(t.storage,t._location,Ca());return t.storage.makeRequestWithTokens(e,Yn).then(n=>{if(n===null)throw _f();return n})}function dp(t){t._throwIfRoot("deleteObject");const e=np(t.storage,t._location);return t.storage.makeRequestWithTokens(e,Yn)}function fp(t,e){const n=Hf(t._location.path,e),r=new re(t._location.bucket,n);return new ct(t.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ua="storage";function Dp(t,e,n){return t=J(t),cp(t,e,n)}function Lp(t){return t=J(t),lp(t)}function Up(t){return t=J(t),up(t)}function Mp(t){return t=J(t),dp(t)}function xp(t,e){return t=J(t),mp(t,e)}function yp(t=qn(),e){t=J(t);const r=zn(t,Ua).getImmediate({identifier:e}),s=Ao("storage");return s&&vp(r,...s),r}function vp(t,e,n,r={}){_p(t,e,n,r)}function wp(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new mr(n,r,s,e,ht)}function Ip(){rt(new qe(Ua,wp,"PUBLIC").setMultipleInstances(!0)),ve(_o,yo,""),ve(_o,yo,"esm2017")}Ip();const Ep={apiKey:"AIzaSyDXlu3twONtxnlsSYAjJcLng0UsNEgKkkg",authDomain:"fototv-90cf0.firebaseapp.com",projectId:"fototv-90cf0",storageBucket:"fototv-90cf0.firebasestorage.app",messagingSenderId:"341116492373",appId:"1:341116492373:web:74768f1c508198574d12dc",measurementId:"G-K7K2NXMWW3"},_r=Zl().length?qn():Co(Ep),Tp=Td(_r);uu(Tp,sa).catch(t=>console.error("Error setting auth persistence:",t));Zd(_r);const Fp=yp(_r);console.log("Firebase initialized with email/password authentication");export{Tp as a,ms as b,kp as c,Mp as d,Cp as e,Pp as f,Up as g,Rp as h,bp as i,Np as j,Lp as l,Op as o,xp as r,Fp as s,Dp as u};
